...
4: ['블랙 위도우', '랑종', '발신제한', '크루엘라']


li = ["블랙 위도우", "발신제한", "콰이어트 플레이스"]
print("1: "+str(li))
...
'''
//문제
[1,2,3,4,5]의 데이터를 가지는 리스트의 평균을 출력하시오.
...
'''
//문제
슬라이싱을 사용해 1~10까지 수가 저장된 리스트에서 짝수, 홀수만 출력하는 프로그램을 작성하시오
